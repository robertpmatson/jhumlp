...
Now we will partition our data into a training and validation set. We will take 60% of our data for training the model and the remaining 40% for model validation. We will split over the response variable to get an equal proportion of "classe" values in each set.
